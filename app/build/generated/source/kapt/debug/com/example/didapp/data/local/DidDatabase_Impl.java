...
public final class DidDatabase_Impl extends DidDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b86400a461dc63746fddc2dd44c9a04d')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoDidItems.equals(_existingDidItems)) {
          return new RoomOpenHelper.ValidationResult(false, "did_items(com.example.didapp.data.local.DidEntity).\n"
                  + " Expected:\n" + _infoDidItems + "\n"
                  + " Found:\n" + _existingDidItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "b86400a461dc63746fddc2dd44c9a04d", "f466792e900a1cf2967b1084bd5c20e7");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "did_items");
  }
